...
public class MainActivity extends AppCompatActivity {
    ...
    aleatorio i1 = new aleatorio(R.drawable.uno, "El castillo vagabundo", R.raw.ring1);
    aleatorio i2 = new aleatorio(R.drawable.dos, "El viaje de Chihiro", R.raw.ring2);
    aleatorio i3 = new aleatorio(R.drawable.tres, "Mi vecino Totoro", R.raw.ring3);
    aleatorio i4 = new aleatorio(R.drawable.cuatro, "Ghilbi", R.raw.ring4);
    aleatorio i5 = new aleatorio(R.drawable.cinco, "Estudio", R.raw.ring5);
    aleatorio i6 = new aleatorio(R.drawable.seis, "Poster 1", R.raw.ring6);
    aleatorio i7 = new aleatorio(R.drawable.siete, "Poster 2", R.raw.ring7);
